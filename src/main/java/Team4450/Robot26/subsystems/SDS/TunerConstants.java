...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        ...
        .withCurrentLimits(new CurrentLimitsConfigs().withStatorCurrentLimit(Amps.of(50)).withStatorCurrentLimitEnable(true));
    ...
    private static final double kCoupleRatio = 4.5; // 4450: Quite different than test robot (0).
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.078857421875);
     ...
     * 4450-NOTE: 100hz update period is for rio can bus/sim. If on
     * a CANIvore it should be 250.
     */
    public static CommandSwerveDrivetrain createDrivetrain() {
        ...
        return new CommandSwerveDrivetrain(
            DrivetrainConstants, updatePeriod, FrontLeft, FrontRight, BackLeft, BackRight
        );  // 4450
    }
